...
db=mysql.connector.connect(user="root",passwd="K30&&bb#",host="localhost") 
...
db=mysql.connector.connect(user="root",passwd="K30&&bb#",host="localhost",database='Shop') 
my_cursor=db.cursor()
...
def addProd(): 
    ...
    #Creating the window
    wn = tkinter.Tk() 
    wn.title("Dairy Shop Management System")
    wn.configure(bg='papayawhip')
    ...
    headingLabel = Label(headingFrame1, text="Add a Product", fg='grey19', font=('Times New Roman',15,'bold'))
    ...
    Quit= Button(wn,text="QUIT",bg='wheat1', fg='black',command=wn.destroy)
...
def delProd(): 
    ...
    headingFrame1.place(relx=0.25,rely=0.1,relwidth=0.5,relheight=0.13)
    headingLabel = Label(headingFrame1, text="Delete Product", fg='grey19', font=('Times New Roman',15,'bold'))
    headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
...
def viewProds():
    ...
    Canvas1 = Canvas(wn) 
    Canvas1.config(bg="pink1")
    Canvas1.pack(expand=True,fill=BOTH)

    headingFrame1 = Frame(wn,bg='pink1',bd=5)
    headingFrame1.place(relx=0.25,rely=0.1,relwidth=0.5,relheight=0.13)

    headingLabel = Label(headingFrame1, text="View Products", fg='black', font = ('Times New Roman',15,'bold'))
    headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
    ...
    Label(labelFrame, text="%-40s%-40s%-40s"%('Date','Product','Price'),font = ('Times New Roman',13,'bold'),
...
def bill():
    ...
    headingFrame1 = Frame(wn,bg="SlateGray1",bd=5)
    ...
    y = 0.35
    Label(labelFrame, text="%-40s%-40s%-40s%-40s"%('Product','Price','Quantity','Total'),font = ('Times New Roman',13,'bold'),
...
def newCust():    
    ...
    headingFrame1 = Frame(wn,bg="SlateGray1",bd=5)
    headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.6,relheight=0.16)
    headingLabel = Label(headingFrame1, text="New Customer", fg='grey19', font=('Times New Roman',15,'bold'))
    headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
    ...
    y = 0.3
    Label(labelFrame, text="Please enter the quantity of the products you want to buy",font = ('Times New Roman',13,'bold'),
    fg='black').place(relx=0.07,rely=0.1)
    
    Label(labelFrame, text="%-30s%-30s%-15s"%('Product','Price','Quantity'),font = ('Times New Roman',13,'bold'),
    fg='black').place(relx=0.07,rely=0.2)
...
wn = tkinter.Tk() 
wn.title("Dairy Shop Management System")
wn.configure(bg='peach puff')
wn.minsize(width=500,height=500)
wn.geometry("700x600")

headingFrame1 = Frame(wn,bg="powder blue",bd=5)
headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.6,relheight=0.16)
headingLabel = Label(headingFrame1, text="Welcome to Dairy \n Shop Management System", fg='grey19', font=('Times New Roman',15,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)

#Button to add a new product
btn1 = Button(wn,text="Add a Product",bg='HotPink1', fg='black', width=20,height=2, command=addProd)
btn1['font'] = font.Font( size=12)
btn1.place(x=270,y=175)

#Button to delete a product
btn2 = Button(wn,text="Delete a Product",bg='sandy brown', fg='black',width=20,height=2,command=delProd)
btn2['font'] = font.Font( size=12)
btn2.place(x=270,y=255)

#Button to view all products
btn3 = Button(wn,text="View Products",bg='turquoise1', fg='black',width=20,height=2,command=viewProds)
btn3['font'] = font.Font( size=12)
btn3.place(x=270,y=335)

#Button to add a new sale and generate bill
btn4 = Button(wn,text="New Customer",bg='plum1', fg='black', width=20,height=2,command = newCust)
